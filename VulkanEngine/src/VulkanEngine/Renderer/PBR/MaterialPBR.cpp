...
namespace ve
{
                             ...
                             const Texture &defaultNormal)
    {
        ...
        VkDescriptorImageInfo aoMetallicRoughnessMapInfo = (m_AoMetallicRoughnessMap ? *m_AoMetallicRoughnessMap : defaultWhite).GetDescriptorInfo();
        ...
        VulkanDescriptorWriter(logicalDevice.GetVkHandle())
            ...
            .WriteImage(Binding::MetallicRoughness, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER,  m_DescriptorSet, aoMetallicRoughnessMapInfo)
